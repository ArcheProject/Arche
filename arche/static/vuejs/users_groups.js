...
Vue.component('user-table', {
  ...
  props: ['api', 'apiAddUser', 'apiRemoveUser'],
  mounted: function() {
    this.getPage();
  },
  methods: {
    ...
    getRange: function(start) {
      ...
      this.loading = true;
      return arche.do_request(this.api, {data: params})
    ...
    addUser: function() {
      ...
      if (!userID) return;
      this.userApi(this.apiAddUser, userID);
    },
    removeUser: function(user) {
      this.userApi(this.apiRemoveUser, user.userid);
    }
  },
  computed: {
